defmodule SnsWeb.UserAuthTest do
  use SnsWeb.ConnCase, async: true

  alias Sns.Users
  alias SnsWeb.UserAuth
  import Sns.UsersFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SnsWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      SnsWeb.Endpoint.subscribe(live_socket_id)
